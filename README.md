...
https://github.com/coding-to-music/next-graphix-mern-visx
...
git branch -M main
git remote add origin git@github.com:coding-to-music/next-graphix-mern-visx.git
...
```java
heroku create next-graphix-mern-visx
```
...
heroku config:set PUBLIC_URL="https://next-graphix-mern-visx.herokuapp.com"
```
...
```java
=== next-graphix-mern-visx Buildpack URL
heroku/nodejs
```
...
```java
Buildpack added. Next release on next-graphix-mern-visx will use:
  1. heroku/nodejs
...
```java
Upgrading /mnt/volume_nyc1_01/next-graphix-mern-visx/package.json
[====================] 15/15 100%
...
```java
Upgrading /mnt/volume_nyc1_01/next-graphix-mern-visx/client/package.json
[====================] 18/18 100%
